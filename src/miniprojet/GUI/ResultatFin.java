...
/**
 * Permet d'accéder aux résultats du tour final du tournoi
 */
public class ResultatFin extends JFrame {
    ...
    class ValiderListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            dispose();
            Bar.getInstance().getSimulation().getTournoi().finaliser();
            Bar.getInstance().getSimulation().setTournoi(new Tournoi());
